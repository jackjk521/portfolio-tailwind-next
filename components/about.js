  ...
  return (
    ...
    <div class="grid grid-cols-12 gap-4 p-1 mb-3">
      ...
      <div class="col-span-12 rounded-lg flex items-center bg-gray-900 p-5 sm:col-span-8">
        ...
        <div class="flex flex-col items-start  px-5 ps-8 pt-4 w-full">
          <h1 class="font-playfair-display text-xl sm:text-2xl lg:text-4xl font-bold">Full Stack</h1>
          <h1 class="font-playfair-display text-md sm:text-2xl lg:text-4xl font-bold">Software Engineer</h1>
          <h1 class="font-playfair-display text-md sm:text-2xl lg:text-4xl font-bold" >with a </h1>
        </div>
        <motion.svg
